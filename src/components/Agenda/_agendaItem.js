        ...
        <div style={{ lineHeight: '2rem', flexGrow: '1' }}>
          <AgendaItemMois theme={theme}>
            {!item.dateFinEvenement
              ...
              : format(new Date(item.dateDebutEvenement), 'dd LLL', { locale: fr }) +
                ' au ' +
                format(new Date(item.dateFinEvenement), 'dd LLL yyyy', { locale: fr })}
          </AgendaItemMois>
          &nbsp;|&nbsp;
          {displayName && (
          ...
          <AgendaItemContent>
            <Text
              ...
              style={{ lineHeight: '2rem', wordBreak: 'auto-phrase', fontSize: '1.6rem' }}
            />
          </AgendaItemContent>
        </div>
      </ItemWrapper>
